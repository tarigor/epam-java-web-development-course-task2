...
<head>
	...
	<link rel="stylesheet" href="../../css/after-download.css" media="screen">
	...
	<meta property="og:title" content="after download">
...
<section class="u-clearfix u-grey-5 u-section-3" id="sec-3ee9">
	<div class="u-clearfix u-sheet u-sheet-1">
		<h3 class="u-text u-text-1">Downloaded text</h3>
		<pre class="u-text-my u-text-2">${pageContext.request.getAttribute("fullText")}
		</pre>
	</div>
</section>
